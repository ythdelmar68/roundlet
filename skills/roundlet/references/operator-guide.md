...
- Generation `g+1` must verify the preserved checkpoint and complete missing validation before continuing. It inherits the same logical objective, candidate history, accepted Supervisor results, review epoch/round/attempt, external/lifecycle sequences, and single final-repair allowance. It cannot manufacture PASS or reset a budget.
