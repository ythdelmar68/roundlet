...
2. reserves the stable run ID, then proves and cleans the Launcher's advisory route plus a short-lived configured Worker's linked-worktree file and Git-index routes with real same-run canaries;
